...
/*   Updated: 2025/02/17 14:36:05 by vagarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    return (sim->num_must_eat != -1 && philo->eat_count >= sim->num_must_eat);
}

void *philo_life(void *arg)
{
    t_philo_data	*data = (t_philo_data *)arg;
    t_sim			*sim = data->sim;
    t_philo			*philo = sim->philo;
