...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/28 15:46:52 by vagarcia          #+#    #+#             */
/*   Updated: 2024/11/28 17:25:08 by vagarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av, char *envp[])
{
    ...
    outfile = open_file(av[4], O_WRONLY | O_CREAT | O_TRUNC);
    char **cmd1_args = split_command(av[2]);
    char **cmd2_args = split_command(av[3]);
